...
- **Python** — basedpyright-langserver (`--stdio`, `pip install basedpyright` / `uv tool install basedpyright`). pyright исключён: не реализует semantic tokens; basedpyright поддерживает и подсветку, и `gd`
