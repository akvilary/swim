...
- `.command` — командная строка (:w, :q, :wq, :q!, :qa, :e path, :e! path, :bd, :bd!, :%s/old/new/g, /search). Доступна из любого окна через `:` — фокус остаётся в панели, ввод идёт через строку состояния (см. Application)
