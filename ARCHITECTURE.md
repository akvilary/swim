...
**Прокрутка вывода:** `up/down` — построчно, `Ctrl+Up/Down`, `PageUp/PageDown` — страница, `Ctrl+D/U` — полстраницы. Ввод любого символа, `Enter`, `Escape` или `Tab` возвращают вид к живому приглашению; новый вывод прилипает к низу только если вид уже внизу — отмотанный вверх вид не прыгает.
